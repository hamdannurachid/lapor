...
<head>
    ...
    <title>Export - Pengaduan Kecamatan Sumedang Utara</title>
    <!-- Bootstrap core CSS-->
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        ...
                        .css( 'font-size', '10pt' )
                        .prepend(
                            '<img src="../images/smd/logo-smd.png" style="opacity: 0.5; display:block;margin-left: auto; margin-top: auto; margin-right: auto; width: 100px;" />'
                        );
                    }
                },
                {
